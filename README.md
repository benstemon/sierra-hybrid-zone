...
The link to supplemental data is here: [`name`](link to data repo)

The raw reads associated with this study are stored in the SRA repository under project number PRJNA1403563: [`url to SRA data`](link to SRA data)
...
Fix elevation estimates for samples and run elevation vs. admixture GLMs

### [DFR-like gene tree](12.DFRlike-genetree)
Estimate the gene tree for DFR, DFR-like, and ANR
